...
var url = "https://raw.githubusercontent.com/rebeccachapman/AppliedClimate/master/HPOM/sample.csv";
...
var HPOM = JSON.parse(Get('https://raw.githubusercontent.com/rebeccachapman/AppliedClimate/master/HPOM/TXctract.geojson'));	
...
/*var district = new L.Shapefile('https://94ycwang.github.io/Texas_5km_grid.zip');
console.log(district);
shp('https://94ycwang.github.io/I&M_5km_grid.zip').then(function(data){
